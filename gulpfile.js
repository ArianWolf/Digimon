...
gulp.task('styles', function () {
  return gulp.src(['app/styles/main.less', 'app/styles/vendor/pages.less'])
    .pipe($.changed('styles', {extension: '.less'}))
    .pipe($.less({
      paths: ['app/styles', 'app/styles/vendor', 'bower_components']
    }))
...
gulp.task('html', ['styles'], function () {
  ...
  var cssChannel = lazypipe()
    ...
    .pipe($.replace, /fonts\/pages-icon/g, 'fonts')
...
// Run Hapi server which conins the API
gulp.task('server', function() {
  $.nodemon({
    script: 'server.js',
    watch: ['server.js', 'manifest.json', 'server'],
    ignore: ['node_modules']
  });
});
